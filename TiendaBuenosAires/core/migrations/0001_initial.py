# Generated by Django 4.0.4 on 2022-05-28 23:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rut_cli', models.ForeignKey(db_column='rutcli', on_delete=django.db.models.deletion.DO_NOTHING, related_name='rut_cliente', to=settings.AUTH_USER_MODEL)),
                ('rut_tec', models.ForeignKey(blank=True, db_column='ruttec', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='rut_tecnico', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='WebFactura',
            fields=[
                ...
                ('fechafac', models.DateField(verbose_name='Fecha factura')),
                ...
                ('idp', models.OneToOneField(db_column='idp', on_delete=django.db.models.deletion.DO_NOTHING, to='core.producto')),
        ...
        migrations.CreateModel(
            name='GuiasDespacho',
            fields=[
                ('numeroOD', models.AutoField(primary_key=True, serialize=False, verbose_name='Numero guia de despacho')),
                ('estadogd', models.CharField(choices=[('B', 'En Bodega'), ('D', 'Despachado'), ('E', 'Entregado')], default='B', max_length=1)),
                ('idp', models.ForeignKey(db_column='idp', on_delete=django.db.models.deletion.DO_NOTHING, to='core.producto')),
