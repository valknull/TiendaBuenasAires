# Generated by Django 3.2.13 on 2022-07-01 13:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descripcion', models.CharField(max_length=300, null=True, verbose_name='Descripcion factura')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descripcion_requerimiento', models.CharField(max_length=300, verbose_name='Descripción del servicio requerido')),
                ('estado_ss', models.CharField(blank=True, choices=[('P', 'Pendiente'), ('A', 'Fecha Visita Aceptada'), ('MC', 'Fecha modificada cliente'), ('M', 'Fecha Modificada'), ('FVA', 'Fecha de visita acordada'), ('SR', 'Servicio Realizado')], default='P', max_length=3, null=True)),
                ...
                ('nro_factura', models.ForeignKey(blank=True, db_column='nrofac', default='', on_delete=django.db.models.deletion.DO_NOTHING, to='core.webfactura')),
            ],
        ),
        migrations.CreateModel(
            name='GuiasDespacho',
